...
namespace OpenAI_API.Chat
{
    public class GemmaChatRequest
    {
        ...
        /// </summary>
        [JsonProperty("tools")]
        public List<GemmaFunction> Functions { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Creates a new, empty <see cref="GemmaChatRequest"/>
        /// </summary>
        public GemmaChatRequest()
        { }
        ...
        public GemmaChatRequest(GemmaChatRequest basedOn)
        {
            if (basedOn == null)
                return;
